...
import { MulterFile, UserFileRecord } from "../types";
import * as minioService from "./minio.service";
import * as bullmqRepo from "../repos/bullmq.repo";
...
describe("FileUploadService", () => {
  ...
  beforeEach(() => {
    ...
    // Console.log is called in the service, so mock it to avoid noise
